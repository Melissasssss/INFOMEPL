...
print(paste("T-value of the aggregrated data (two-tailed)", as.character(aggregratedT)))
print(paste("P-value of the aggregrated data (two-tailed)", as.character(aggregatedpval)))
