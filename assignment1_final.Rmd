...
*The type is t-test in paired, because participants see all words, so the data is not independent. So we need one datapoint per participant, for both normal and pseudowords. *
...
print(t.test(normal_words, pseudo_words,  paired = FALSE, alternative = "two.sided"))
