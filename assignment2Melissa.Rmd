...
malethres <- thres + stimGenderMaleCoeff
malethresList <-as.list(malethres)


#Using both
probsThres <- lapply(thresList, logFunc)
probsThresMale <- lapply(malethresList, logFunc)


probsThresPnorm <- lapply(thresList, function(prob) pnorm(prob))
probsThresPnormMale <- lapply(malethresList, function(prob) pnorm(prob))
